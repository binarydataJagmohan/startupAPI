        ...
        <tr
            ...
            <td class="container" width="600"
                ...
                <div class="content"
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="text-align: center">
                                            <a href="#" style="display: block;margin-bottom: 10px;">
                                                <img src="{{ env('APP_URL') }}/images/logo.png" height="50"
                                                    alt="logo" /></a> <br />
                                        </td>
                                    </tr>
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            Hi {{ $mail['username'] }},<br>
                                            Congratulations {{ $mail['username'] }}, Your Payment has been done
                                            Successfully.
                                            I hope this email finds you well. We appreciate your recent decision to
                                            invest in {{ $mail['business']->business_name }} through RisingCapitalist.
                                            Attached to this email,
                                            you will find the invoice for your fund purchase.
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            ...
                                            <table cellpadding="0" cellspacing="0"
                                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <tr style="background-color:#9fe870;">
                                                    <td colspan="2" width="100%"
                                                        style="padding: 8px; border: 1px solid #ddd;">Fund Invoice</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 8px; border: 1px solid #ddd;"> Startup Stage :
                                                        {{ $mail['business']->stage }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 8px; border: 1px solid #ddd;">
                                                        Repayment Date :
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 8px; border: 1px solid #ddd;">
                                                        {{ $mail['booking']['subscription_value'] }}</td>
                                                </tr>
                                                <tr>
                                                    <td
                                                        ...
                                                        Grand Total:</td>
                                                    <td style="padding: 8px; border: 1px solid #ddd;">
                                                        ${{ $mail['booking']['repayment_value'] }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                    ...
                    <p
                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0 0 20px; text-align: left;">
                        Should you have any questions or require further clarification regarding the invoice, feel free
                        to reach out to us at info@risingcapitalist.com. Thank you for choosing us for your investment
                        needs. We look forward to a long and successful partnership.
                        <br><br>
                        Best regards,<br>
                        RisingCapitalist
                    </p>
