...
{
    public function get_investor_message_data(Request $request)
    {
            $userId = $request->id;
    ...
    public function contact_user_by_investor(Request $request)
    {
        try {
    ...
    public function get_click_investor_user_chat_data(Request $request)
    {
        try {
    ...
    public function contact_user_by_investor_with_share_file(Request $request)
    {   
     ...
     public function get_admin_data_investor(Request $request)
    {
        try {
    ...
    public function create_group_by_investor(Request $request)
    {
        try {
            $group_name =  $request->group_name;
            $group_admin_id =  $request->group_admin_id;
            $group_business_id = $request->group_business_id;
            ...
            $chat_group->group_business_id =  $group_business_id;
    ...
    public function get_single_group_data(Request $request)
    {
        try {
            $group_business_id = $request->group_business_id;
            $chat_group_data = ChatGroups::where('group_business_id', $group_business_id)->first();
            if($chat_group_data){
                return response()->json(['status' => true, 'message' => "all group data", 'data' => $chat_group_data]);
            } else {
                return response()->json(['status' => false, 'message' => "all group data not found", 'data' => '']);
            }
        } catch (\Exception $e) {
            throw new HttpException(500, $e->getMessage());
        }
